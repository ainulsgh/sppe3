...
export default function InputData({ records = [], mode = 'create', record = null, filters = {} }) {
  ...
  const initial = useMemo(() => {
    if (mode === 'edit') {
      ...
      const r = record ?? {
        ...
        retribusi_truk: 0,
        retribusi_pick_up: 0,
        retribusi_parkir_motor: 0,
        retribusi_parkir_angkot: 0,
      };
      return {
        tahun: t, bulan: b,
        daging_sapi: r.daging_sapi,
        retribusi_truk: r.retribusi_truk,
        retribusi_pick_up: r.retribusi_pick_up,
        retribusi_parkir_motor: r.retribusi_parkir_motor,
        retribusi_parkir_angkot: r.retribusi_parkir_angkot,
      };
    }
    return base;
  }, [mode, record, filters]);
  ...
  const submit = (e) => {
    ...
    const action = mode === 'edit' ? route('Perhubungan.upsert') : route('Perhubungan.store');
  ...
  const indikator = [
    ...
    { label: 'Retribusi Parkir Motor',         key: 'retribusi_parkir_motor',   unit: 'Rupiah' },
    { label: 'Retribusi Parkir Angkot',        key: 'retribusi_parkir_angkot',  unit: 'Rupiah' },
  ];
  ...
  return (
    <AuthenticatedLayout header={<div className="flex items-center gap-3">
      ...
      <Head title={isEdit ? 'Edit Data Perhubungan' : 'Dinas Perhubungan'} />
