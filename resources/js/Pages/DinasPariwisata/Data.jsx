// resources/js/Pages/Dinaspariwisata/Data.jsx
...
export default function Data({ records = [], filters = {} }) {
  ...
  return (
    //ganti dinas
    <AuthenticatedLayout header={<span>Dinas Pariwisata</span>}>
      <Head title="Dinas Pariwisata" />
      ...
      <div className="bg-white rounded-2xl shadow-sm border p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-3" ref={exportRef}>
            <Link
              href={`/pariwisata/edit?tahun=${selectedYear ?? ''}&bulan=${selectedMonth ?? ''}`}
            ...
            <div className="relative">
              ...
              {showExport && canAct && (
                <div className="absolute right-0 mt-2 w-44 bg-white rounded-md shadow-lg border z-10">
                  <a
                    href={`/pariwasata/export?format=csv&tahun=${selectedYear}&bulan=${selectedMonth}`}
                    className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100"
                  >
                    Export CSV
                  </a>
                  <a
                    href={`/pariwisata/export?format=xls&tahun=${selectedYear}&bulan=${selectedMonth}`}
                    className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100"
                  >
                    Export Excel
                  </a>
